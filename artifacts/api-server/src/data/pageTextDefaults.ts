...
export const PAGE_TEXT_DEFAULTS: Record<string, PageTexts> = {
  ...
  teams: {
    ...
    fees_heading: "2026/27 Player Fees",
    registration_fee_amount: "HK$100",
    registration_fee_name: "Masters Registration",
    registration_fee_description:
      "Become a registered Masters player and receive regular updates, tournament announcements, and club news.",
    active_fee_amount: "HK$300",
    active_fee_name: "Active Player Fee",
    division_one_fee_amount: "HK$500",
    division_one_fee_name: "Division 1 Squad Fee",
    division_one_fee_description:
      "Required once selected to play in the Hong Kong Hockey League First Division.",
