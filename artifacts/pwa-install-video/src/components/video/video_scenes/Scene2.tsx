    ...
    >
      <div className="flex w-full max-w-6xl items-center justify-between px-20">
        ...
        <div className="w-1/2">
          ...
          <motion.div
            className="mt-8 flex items-center gap-2 text-[var(--color-accent)]/40 text-[1.4vw]"
            initial={{ opacity: 0 }}
            animate={phase >= 3 ? { opacity: 1 } : { opacity: 0 }}
            transition={{ duration: 0.5 }}
          >
            <span>Tap it at the bottom of Safari</span>
          </motion.div>
        </div>
        ...
        >
          <PhoneFrame variant="ios">
            ...
            <div className="flex-1 bg-white p-3 overflow-hidden">
              <div className="w-full h-28 bg-[var(--color-bg-dark)] rounded-xl mb-3 flex items-center justify-center">
                <img
              ...
              <div className="flex gap-2">
                <div className="w-16 h-8 bg-[var(--color-primary)] rounded-lg" />
            ...
            <div className="h-[72px] bg-[#F2F2F7] border-t border-gray-300 flex items-center justify-around px-4 shrink-0">
              ...
              <div className="relative flex items-center justify-center">
                <motion.div
                  animate={phase >= 3 ? { scale: [1, 0.82, 1.15, 1] } : {}}
