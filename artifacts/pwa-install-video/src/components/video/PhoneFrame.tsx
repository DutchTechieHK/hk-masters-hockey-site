  ...
  return (
    <div className={`relative ${className}`} style={{ width: 300, height: 620 }}>
      ...
      >
        ...
        {/* Side highlight — right (power button) */}
        ...
        {/* Screen area (content goes here via foreignObject) */}
        ...
        {isIos ? (
          /* iOS: Dynamic Island */
          <>
            <rect x="108" y="20" width="84" height="28" rx="14"
              fill="#0a0a0f"
            />
            {/* Front camera dot */}
        ...
        {isIos ? (
          <rect x="115" y="598" width="70" height="4" rx="2"
            fill="#ffffff" opacity="0.25"
          />
        ) : (
          /* Android nav hint */
          <rect x="130" y="600" width="40" height="3" rx="1.5"
      ...
      {/* Content area clipped to screen */}
      <div
