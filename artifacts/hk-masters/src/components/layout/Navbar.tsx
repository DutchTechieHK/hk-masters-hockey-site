...
import { Trophy, Users, UserRound, Shirt, DollarSign, Plane, BookOpen, Menu, X, Luggage, Star, CalendarDays, Wallet, LogOut, CalendarClock, Megaphone, History, FolderOpen, Gavel, Package, HandCoins, Footprints, ChevronRight, BarChart2, PlayCircle, FileText, ArrowDownToLine, Search } from "lucide-react"
...
const FUNDRAISING_CHILDREN = [
  ...
  { href: "/fundraising/search", label: "Search", icon: Search },
]
