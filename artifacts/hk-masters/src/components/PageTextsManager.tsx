...
const PAGES: PageDef[] = [
  ...
  },
  {
    page: "teams",
    title: "Teams",
    note: "Squad names, descriptions and staff are managed under Teams — only the page text lives here.",
    fields: [
      { kind: "textarea", key: "page_subtitle", label: "Page Subtitle", hint: "Shown after the World Cup, when the site returns to normal mode" },
      { kind: "text", key: "join_heading", label: "Join Us — Heading" },
      { kind: "textarea", key: "join_text", label: "Join Us — Text" },
    ],
  },
  {
    page: "rotterdam",
