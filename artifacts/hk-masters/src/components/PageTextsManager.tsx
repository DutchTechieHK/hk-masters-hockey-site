...
const PAGES: PageDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "text", key: "fees_heading", label: "Player Fees — Heading" },
      { kind: "text", key: "registration_fee_amount", label: "Masters Registration — Amount" },
      { kind: "text", key: "registration_fee_name", label: "Masters Registration — Tier Name" },
      { kind: "textarea", key: "registration_fee_description", label: "Masters Registration — Description" },
      { kind: "text", key: "active_fee_amount", label: "Active Player Fee — Amount" },
      { kind: "text", key: "active_fee_name", label: "Active Player Fee — Tier Name" },
      { kind: "text", key: "division_one_fee_amount", label: "Division 1 Squad Fee — Amount" },
      { kind: "text", key: "division_one_fee_name", label: "Division 1 Squad Fee — Tier Name" },
      { kind: "textarea", key: "division_one_fee_description", label: "Division 1 Squad Fee — Description" },
