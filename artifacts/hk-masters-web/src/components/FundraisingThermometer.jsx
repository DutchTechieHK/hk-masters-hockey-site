      ...
      {loading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div>
              <p className="text-sm sm:text-xl font-extrabold text-[#006B3C]/60 whitespace-nowrap">{formatHKD(totalPledged)}</p>
              <p className="text-xs text-gray-500 mt-0.5">Total pledged</p>
            </div>
            <div>
              <p className="text-sm sm:text-xl font-extrabold text-[#006B3C] whitespace-nowrap">{formatHKD(totalReceived)}</p>
              <p className="text-xs text-gray-500 mt-0.5">Received</p>
            </div>
            <div>
              <p className="text-sm sm:text-xl font-extrabold text-gray-400 whitespace-nowrap">{formatHKD(goal)}</p>
