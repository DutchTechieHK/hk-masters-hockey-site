  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-12">
        ...
        >
          <img src={`${import.meta.env.BASE_URL}logo.png`} alt="HK Masters Logo" className="h-24 w-auto object-contain" />
        </motion.div>

        <div className="overflow-hidden mb-2">
          <motion.p
            className="text-[1.8vw] font-semibold uppercase tracking-[0.4em]"
        ...
        <div className="overflow-hidden mb-6">
          <motion.h1
            className="text-[5.5vw] font-bold uppercase tracking-wide text-center leading-tight"
            style={{ fontFamily: 'var(--iv-font-display)', color: 'var(--iv-accent)' }}
            initial={{ y: '110%' }}
