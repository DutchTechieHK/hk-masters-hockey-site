      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {gallery.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-gray-200 py-16 text-center text-gray-400">
            ...
            <p className="text-sm mt-1">Add photos via the CMS under Media → Photo Gallery</p>
          </div>
        ) : (
      ...
      {lightbox && (
        ...
        >
          <div className="relative max-w-4xl w-full" onClick={e => e.stopPropagation()}>
            ...
            />
            {lightbox.caption && (
              <p className="text-white text-sm text-center mt-3 opacity-80">{lightbox.caption}</p>
            )}
          </div>
        </div>
      )}
