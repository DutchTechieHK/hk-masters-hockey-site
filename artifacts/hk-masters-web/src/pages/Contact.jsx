            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${content.email}`} className="text-sm font-medium text-[#1E3A6E] hover:underline">
                    {content.email}
                  </a>
                </div>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-3">
                ...
                {content.social.twitter && (
                  <a href={content.social.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter/X"
                    className="w-10 h-10 bg-[#1E3A6E]/10 rounded-lg flex items-center justify-center text-[#1E3A6E] hover:bg-[#1E3A6E] hover:text-white transition-colors duration-150">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
