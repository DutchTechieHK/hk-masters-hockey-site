...
export const ListAnnouncementsQueryParams = zod.object({
  scope: zod.enum(["local_2026_27", "world_cup_2026"]).optional(),
});

export const ListAnnouncementsResponseItem = zod.object({
  operationalScope: zod.enum(["local_2026_27", "world_cup_2026"]).optional(),
  id: zod.number(),
  title: zod.string(),
  body: zod.string(),
...
export const ListPlayersResponseItem = zod.object({
  ...
  hkidNumber: zod.string().optional(),
  ...
  hkidCopyUrl: zod.string().nullish(),
  hkidCopyReviewed: zod.boolean().nullish(),
  hkidCopyUploadedAt: zod.string().nullish(),
  hkidCopyUploadedIsUpdate: zod.boolean().nullish(),
  ...
  outboundFlightNumber: zod.string().optional(),
  outboundDepartureDateTime: zod.string().optional(),
...
export const CreatePlayerBody = zod.object({
  ...
  passportCopyUploadedIsUpdate: zod.boolean().nullish(),
  hkidCopyUrl: zod.string().nullish(),
  hkidCopyReviewed: zod.boolean().optional(),
  hkidCopyUploadedAt: zod.string().nullish(),
  hkidCopyUploadedIsUpdate: zod.boolean().nullish(),
  emergencyContactName: zod.string().optional(),
  emergencyContactPhone: zod.string().optional(),
