...
export const playersTable = pgTable("players", {
  ...
  hkidCopyUrl: text("hkid_copy_url"),
  hkidCopyReviewed: boolean("hkid_copy_reviewed").default(false).notNull(),
  hkidCopyUploadedAt: timestamp("hkid_copy_uploaded_at"),
  hkidCopyUploadedIsUpdate: boolean("hkid_copy_uploaded_is_update").default(false).notNull(),
