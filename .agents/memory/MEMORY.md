...
- [DB migration convention](db-migration-convention.md) — drizzle push updates dev only; prod needs a hand-written idempotent ALTER TABLE file in lib/db/migrations/ + redeploy.
