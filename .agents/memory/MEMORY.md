...
- [DB migration convention](db-migration-convention.md) — schema + Publish remains primary; deploy-critical constraints may also need idempotent compatibility SQL. Never use startup DDL.
